...
export function calculateDogAge(ageOfDog) {
  const conversionRate = 7;
  const ageInDogYears = conversionRate * ageOfDog;
  const ageMessage = `Your doggie is ${ageInDogYears} years old in dog years!`;
  return ageMessage;
}
